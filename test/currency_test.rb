...
class CurrencyTest < Minitest::Test
  ...
  def can_create_new_instance_with_new
    amount = 10
    currency_code = "USD"
  ...
  def currency_has_an_amount_and_currency_code
    amount = 20
    currency_code = "CAD"
  ...
  def equals_another_currency_obj_with_same_amount_and_currency_code
    amount = 50
    currency_code = "USD"
  ...
  def can_be_added_to_another_currency_obj_with_the_same_currency_code
  ...
  def can_be_subtracted_by_another_currency_obj_with_the_same_currency_code
  ...
  def raises_error_when_using_different_currency_codes
  ...
  def can_be_multiplied_by_fixnum_or_float_and_return_currency_obj
